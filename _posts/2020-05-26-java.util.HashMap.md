...
tags: jdk14 源码
---
本文尝试详细阐述一下一下jdk14的[HashMap](http://hg.openjdk.java.net/jdk/jdk/file/jdk-14-ga/src/java.base/share/classes/java/util/HashMap.java)源码。
[jdk6](http://hg.openjdk.java.net/jdk6/jdk6/jdk/file/default/src/share/classes/java/util/HashMap.java)
[jdk7](http://hg.openjdk.java.net/jdk/jdk/file/jdk7-b100/jdk/src/share/classes/java/util/HashMap.java)
...
另外，bin中节点数量少的话，链表的读写综合性能足够好，数量多的话，红黑树才有优势。这就必然存在一个临界值，取8就比较合适。
